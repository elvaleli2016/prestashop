<?php /* Smarty version Smarty-3.1.19, created on 2017-08-28 18:32:49
         compiled from "C:\xampp\htdocs\prestashopCambio\admin\themes\default\template\controllers\attribute_generator\content.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1279559a445b1708489-40252731%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '769139692a5c7e9ea4c192b931b724cf3ef39fb0' => 
    array (
      0 => 'C:\\xampp\\htdocs\\prestashopCambio\\admin\\themes\\default\\template\\controllers\\attribute_generator\\content.tpl',
      1 => 1502749860,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1279559a445b1708489-40252731',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59a445b17dfbd8_15492553',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59a445b17dfbd8_15492553')) {function content_59a445b17dfbd8_15492553($_smarty_tpl) {?>
...
?>
			<?php ob_start();?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['attrname']->value);?>
...
<?php if ($_smarty_tpl->tpl_vars['generate']->value) {?><div class="alert alert-success clearfix"><?php echo smartyTranslate(array('s'=>'%d product(s) successfully created.','sprintf'=>array($_smarty_tpl->tpl_vars['combinations_size']->value)),$_smarty_tpl);?>
</div><?php }?>
...
" label="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['attribute_group']->value['name'],'html','UTF-8');?>
">
...
" value="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['v']->value,'html','UTF-8');?>
" title="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['v']->value,'html','UTF-8');?>
"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['v']->value,'html','UTF-8');?>
</option>
									<?php } ?>
								</optgroup>
							<?php }?>
				...
				<div class="form-group">
					<button type="button" class="btn btn-default" onclick="del_attr_multiple();"><i class="icon-minus-sign"></i> <?php echo smartyTranslate(array('s'=>'Delete','d'=>'Admin.Actions'),$_smarty_tpl);?>
</button>
					<button type="button" class="btn btn-default pull-right" onclick="add_attr_multiple();"><i class="icon-plus-sign"></i> <?php echo smartyTranslate(array('s'=>'Add','d'=>'Admin.Actions'),$_smarty_tpl);?>
</button>
				</div>
			</div>
 ...
 <b><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['product_name']->value,'html','UTF-8');?>
</b></div>
...
?>
					...
					<div class="row">
						<table class="table" style="display:none">
							<thead>
								<tr>
									<th id="tab_h1" class="fixed-width-md"><span class="title_box"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['attribute_group']->value['name'],'html','UTF-8');?>
</span></th>
				...
				<table class="table">
					<tbody>
						...
						<tr>
							...
							<td><input type="text" name="reference" value="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['product_reference']->value,'html','UTF-8');?>
" /></td>
						</tr>
					</tbody>
				</table>
