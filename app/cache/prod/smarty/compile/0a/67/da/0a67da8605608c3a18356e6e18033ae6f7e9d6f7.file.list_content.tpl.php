<?php /* Smarty version Smarty-3.1.19, created on 2017-08-28 18:32:53
         compiled from "C:\xampp\htdocs\prestashopCambio\admin\themes\default\template\controllers\tax_rules\helpers\list\list_content.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2498559a445b5107b55-54842717%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0a67da8605608c3a18356e6e18033ae6f7e9d6f7' => 
    array (
      0 => 'C:\\xampp\\htdocs\\prestashopCambio\\admin\\themes\\default\\template\\controllers\\tax_rules\\helpers\\list\\list_content.tpl',
      1 => 1502749860,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2498559a445b5107b55-54842717',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59a445b51f41e5_20969790',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59a445b51f41e5_20969790')) {function content_59a445b51f41e5_20969790($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_regex_replace')) include 'C:\\xampp\\htdocs\\prestashopCambio\\vendor\\prestashop\\smarty\\plugins\\modifier.regex_replace.php';
?>
<tbody>
...
<?php }?>
				...
				<?php } elseif (isset($_smarty_tpl->tpl_vars['params']->value['activeVisu'])) {?>
					...
					alt="<?php if ($_smarty_tpl->tpl_vars['tr']->value[$_smarty_tpl->tpl_vars['key']->value]) {?><?php echo smartyTranslate(array('s'=>'Enabled','d'=>'Admin.Global'),$_smarty_tpl);?>
<?php } else { ?><?php echo smartyTranslate(array('s'=>'Disabled','d'=>'Admin.Global'),$_smarty_tpl);?>
<?php }?>" title="<?php if ($_smarty_tpl->tpl_vars['tr']->value[$_smarty_tpl->tpl_vars['key']->value]) {?><?php echo smartyTranslate(array('s'=>'Enabled','d'=>'Admin.Global'),$_smarty_tpl);?>
<?php } else { ?><?php echo smartyTranslate(array('s'=>'Disabled','d'=>'Admin.Global'),$_smarty_tpl);?>
<?php }?>" />
...
" <?php if (!($_smarty_tpl->tpl_vars['tr']->value[$_smarty_tpl->tpl_vars['key']->value]['position']!=$_smarty_tpl->tpl_vars['positions']->value[count($_smarty_tpl->tpl_vars['positions']->value)-1])) {?>style="display: none;"<?php }?>>
							<img src="../img/admin/<?php if ($_smarty_tpl->tpl_vars['order_way']->value=='ASC') {?>down<?php } else { ?>up<?php }?>.gif" alt="<?php echo smartyTranslate(array('s'=>'Down','d'=>'Admin.International.Feature'),$_smarty_tpl);?>
" title="<?php echo smartyTranslate(array('s'=>'Down','d'=>'Admin.International.Feature'),$_smarty_tpl);?>
" />
						</a>
...
" <?php if (!($_smarty_tpl->tpl_vars['tr']->value[$_smarty_tpl->tpl_vars['key']->value]['position']!=$_smarty_tpl->tpl_vars['positions']->value[0])) {?>style="display: none;"<?php }?>>
							<img src="../img/admin/<?php if ($_smarty_tpl->tpl_vars['order_way']->value=='ASC') {?>up<?php } else { ?>down<?php }?>.gif" alt="<?php echo smartyTranslate(array('s'=>'Up','d'=>'Admin.International.Feature'),$_smarty_tpl);?>
" title="<?php echo smartyTranslate(array('s'=>'Up','d'=>'Admin.International.Feature'),$_smarty_tpl);?>
" />
						</a>
					<?php } else { ?>
				...
				<?php } elseif (isset($_smarty_tpl->tpl_vars['tr']->value[$_smarty_tpl->tpl_vars['key']->value])) {?>
					<?php if ($_smarty_tpl->tpl_vars['key']->value=='behavior') {?>
						<?php if ($_smarty_tpl->tpl_vars['tr']->value[$_smarty_tpl->tpl_vars['key']->value]==0) {?>
							<?php echo smartyTranslate(array('s'=>'This tax only','d'=>'Admin.International.Feature'),$_smarty_tpl);?>

						<?php } elseif ($_smarty_tpl->tpl_vars['tr']->value[$_smarty_tpl->tpl_vars['key']->value]==1) {?>
							<?php echo smartyTranslate(array('s'=>'Combine','d'=>'Admin.International.Feature'),$_smarty_tpl);?>

						<?php } elseif ($_smarty_tpl->tpl_vars['tr']->value[$_smarty_tpl->tpl_vars['key']->value]==2) {?>
							<?php echo smartyTranslate(array('s'=>'One after another','d'=>'Admin.International.Feature'),$_smarty_tpl);?>
