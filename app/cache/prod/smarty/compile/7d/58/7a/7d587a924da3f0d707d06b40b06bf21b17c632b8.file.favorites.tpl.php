<?php /* Smarty version Smarty-3.1.19, created on 2017-08-28 18:32:51
         compiled from "C:\xampp\htdocs\prestashopCambio\admin\themes\default\template\controllers\modules\favorites.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1867259a445b33cb797-96332903%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7d587a924da3f0d707d06b40b06bf21b17c632b8' => 
    array (
      0 => 'C:\\xampp\\htdocs\\prestashopCambio\\admin\\themes\\default\\template\\controllers\\modules\\favorites.tpl',
      1 => 1502749860,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1867259a445b33cb797-96332903',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59a445b3450302_37961597',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59a445b3450302_37961597')) {function content_59a445b3450302_37961597($_smarty_tpl) {?>
<div class="panel">
...
<?php } else { ?><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['t2']->value['name'],'html','UTF-8');?>
<?php }?></option>
													<?php }?>
												<?php } ?>
											<?php }?>
...
" class="moduleFavorite">
										...
										<option value="1" <?php if (isset($_smarty_tpl->tpl_vars['module']->value->preferences['interest'])&&$_smarty_tpl->tpl_vars['module']->value->preferences['interest']=='1') {?>selected="selected"<?php }?>><?php echo smartyTranslate(array('s'=>'Yes','d'=>'Admin.Global'),$_smarty_tpl);?>
</option>
										<option value="0" <?php if (isset($_smarty_tpl->tpl_vars['module']->value->preferences['interest'])&&$_smarty_tpl->tpl_vars['module']->value->preferences['interest']=='0') {?>selected="selected"<?php }?>><?php echo smartyTranslate(array('s'=>'No','d'=>'Admin.Global'),$_smarty_tpl);?>
</option>
									</select>
								</td>
								<td>
...
" class="moduleFavorite">
										<option value="" selected="selected">-</option>
										<option value="1" <?php if (isset($_smarty_tpl->tpl_vars['module']->value->preferences['favorite'])&&$_smarty_tpl->tpl_vars['module']->value->preferences['favorite']=='1') {?>selected="selected"<?php }?>><?php echo smartyTranslate(array('s'=>'Yes','d'=>'Admin.Global'),$_smarty_tpl);?>
</option>
										<option value="0" <?php if (isset($_smarty_tpl->tpl_vars['module']->value->preferences['favorite'])&&$_smarty_tpl->tpl_vars['module']->value->preferences['favorite']=='0') {?>selected="selected"<?php }?>><?php echo smartyTranslate(array('s'=>'No','d'=>'Admin.Global'),$_smarty_tpl);?>
</option>
									</select>
								</td>
							</tr>
