<?php /* Smarty version Smarty-3.1.19, created on 2017-08-28 18:32:51
         compiled from "C:\xampp\htdocs\prestashopCambio\admin\themes\default\template\controllers\orders\form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1134059a445b3dee9d4-03660761%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6b726e5db9377fa5b5512821bd85763ea624b683' => 
    array (
      0 => 'C:\\xampp\\htdocs\\prestashopCambio\\admin\\themes\\default\\template\\controllers\\orders\\form.tpl',
      1 => 1502749860,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1134059a445b3dee9d4-03660761',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59a445b4037495_39548966',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59a445b4037495_39548966')) {function content_59a445b4037495_39548966($_smarty_tpl) {?>
...
";
	...
	var current_index = '<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['current']->value,'html','UTF-8');?>
...
', {
					...
					parse: function(data) {
						if (!data.found)
							$('#vouchers_err').html('<?php echo smartyTranslate(array('s'=>'No voucher was found','d'=>'Admin.Orderscustomers.Notification'),$_smarty_tpl);?>
').show();
						else
							$('#vouchers_err').hide();
						var mytab = new Array();
...
&id_customer=' + this.id_customer + '&viewcustomer&liteDisplaying=1" class="btn btn-default fancybox"><i class="icon-search"></i> <?php echo smartyTranslate(array('s'=>'Details','d'=>'Admin.Global'),$_smarty_tpl);?>
</a>';
            html += '<button type="button" data-customer="' + this.id_customer + '" class="setup-customer btn btn-default pull-right"><i class="icon-arrow-right"></i> <?php echo smartyTranslate(array('s'=>'Choose','d'=>'Admin.Actions'),$_smarty_tpl);?>
</button>';
            html += '</div>';
            html += '</div>';
            html += '</div>';
          ...
          html = '<div class="alert alert-warning"><?php echo smartyTranslate(array('s'=>'No customers found','d'=>'Admin.Orderscustomers.Notification'),$_smarty_tpl);?>
</div>';
        }
			...
			success : function(res)
			{
				if(res.found)
				{
					...
					$.each(res.carts, function() {
						...
						html_carts += '<a title="<?php echo smartyTranslate(array('s'=>'View this cart','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl);?>
...
&liteDisplaying=1#"><i class="icon-search"></i>&nbsp;<?php echo smartyTranslate(array('s'=>'Details','d'=>'Admin.Global'),$_smarty_tpl);?>
</a>';
						html_carts += '&nbsp;<a href="#" title="<?php echo smartyTranslate(array('s'=>'Use this cart','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl);?>
" class="use_cart btn btn-default" rel="'+this.id_cart+'"><i class="icon-arrow-right"></i>&nbsp;<?php echo smartyTranslate(array('s'=>"Use",'d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl);?>
</a>';
						html_carts += '</td>';
						html_carts += '</tr>';
					});
...
&id_order='+this.id_order+'&vieworder&liteDisplaying=1#" title="<?php echo smartyTranslate(array('s'=>'View this order','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl);?>
" class="fancybox btn btn-default"><i class="icon-search"></i>&nbsp;<?php echo smartyTranslate(array('s'=>"Details",'d'=>'Admin.Global'),$_smarty_tpl);?>
</a>';
						html_orders += '&nbsp;<a href="#" "title="<?php echo smartyTranslate(array('s'=>'Duplicate this order','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl);?>
" class="duplicate_order btn btn-default" rel="'+this.id_order+'"><i class="icon-arrow-right"></i>&nbsp;<?php echo smartyTranslate(array('s'=>"Use",'d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl);?>
</a>';
						html_orders += '</td>';
						html_orders += '</tr>';
					});
	...
	function updateDeliveryOptionList(delivery_option_list)
	{
		...
		{
			$('#carrier_form').hide();
			$('#carriers_err').show().html('<?php echo smartyTranslate(array('s'=>'No carrier can be applied to this order','d'=>'Admin.Orderscustomers.Notification'),$_smarty_tpl);?>
');
...
",
			...
			success : function(res)
			{
				...
				if(res.found)
				{
					...
					$('#products_found').show();
					products_found += '<label class="control-label col-lg-3"><?php echo smartyTranslate(array('s'=>'Product','d'=>'Admin.Global'),$_smarty_tpl);?>
</label><div class="col-lg-6"><select id="id_product" onclick="display_product_attributes();display_product_customizations();"></div>';
					attributes_html += '<label class="control-label col-lg-3"><?php echo smartyTranslate(array('s'=>'Combination','d'=>'Admin.Global'),$_smarty_tpl);?>
					...
					$.each(res.products, function() {
						...
						{
							customization_html += '<div class="bootstrap"><div class="panel"><div class="panel-heading"><?php echo smartyTranslate(array('s'=>'Customization','d'=>'Admin.Catalog.Feature'),$_smarty_tpl);?>
				...
				{
					$('#products_found').hide();
					$('#products_err').html('<?php echo smartyTranslate(array('s'=>'No products found','d'=>'Admin.Orderscustomers.Notification'),$_smarty_tpl);?>
');
...
</td><td>'+this.cart_quantity+'</td><td><?php echo smartyTranslate(array('s'=>'Gift','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl);?>
</td></tr>';
		});
		...
		if (typeof(vouchers) == 'object')
			$.each(vouchers, function(){
				if (parseFloat(this.value_real) === 0 && parseInt(this.free_shipping) === 1)
					var value = '<?php echo smartyTranslate(array('s'=>'Free shipping','d'=>'Admin.Shipping.Feature'),$_smarty_tpl);?>
';
				else
					var value = this.value_real;

				vouchers_html += '<tr><td>'+this.name+'</td><td>'+this.description+'</td><td>'+value+'</td><td class="text-right"><a href="#" class="btn btn-default delete_discount" rel="'+this.id_discount+'"><i class="icon-remove text-danger"></i>&nbsp;<?php echo smartyTranslate(array('s'=>'Delete','d'=>'Admin.Actions'),$_smarty_tpl);?>
</a></td></tr>';
			});
...
&id_address="+this.id_address+"&updateaddress&realedit=1&liteDisplaying=1&submitFormAjax=1#";
		...
		{
			$('#addresses_err').show().html('<?php echo smartyTranslate(array('s'=>'You must add at least one address to process the order.','d'=>'Admin.Orderscustomers.Notification'),$_smarty_tpl);?>
');
	...
	<div class="panel form-horizontal" id="customer_part">
		...
		<div id="search-customer-form-group" class="form-group">
			<label class="control-label col-lg-3">
				<span title="" data-toggle="tooltip" class="label-tooltip" data-original-title="<?php echo smartyTranslate(array('s'=>'Search for an existing customer by typing the first letters of his/her name.','d'=>'Admin.Orderscustomers.Help'),$_smarty_tpl);?>
">
					<?php echo smartyTranslate(array('s'=>'Search for a customer','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl);?>
			...
			<div class="col-lg-9">
				<div class="row">
					...
					<div class="col-lg-6">
						<span class="form-control-static"><?php echo smartyTranslate(array('s'=>'Or','d'=>'Admin.Global'),$_smarty_tpl);?>
&nbsp;</span>
						<a class="fancybox_customer btn btn-default" href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminCustomers'),'html','UTF-8');?>
&amp;addcustomer&amp;liteDisplaying=1&amp;submitFormAjax=1#">
							<i class="icon-plus-sign-alt"></i>
							<?php echo smartyTranslate(array('s'=>'Add new customer','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl);?>
			...
			<ul id="old_carts_orders_navtab" class="nav nav-tabs">
				<li class="active">
					<a href="#nonOrderedCarts" data-toggle="tab">
						...
						<?php echo smartyTranslate(array('s'=>'Carts','d'=>'Admin.Global'),$_smarty_tpl);?>
					...
					<table class="table">
						<thead>
							<tr>
								...
								<th><span class="title_box"><?php echo smartyTranslate(array('s'=>'Total paid','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl);?>
</span></th>
...
<form class="form-horizontal" action="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminOrders'),'html','UTF-8');?>
&amp;submitAdd<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['table']->value,'html','UTF-8');?>
=1" method="post" autocomplete="off">
	<div class="panel" id="products_part" style="display:none;">
		<div class="panel-heading">
			<i class="icon-shopping-cart"></i>
			<?php echo smartyTranslate(array('s'=>'Cart','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl);?>
...
">
					<?php echo smartyTranslate(array('s'=>'Search for a product','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl);?>
...
" />
			...
			<div class="form-group">
				<label class="control-label col-lg-3" for="qty"><?php echo smartyTranslate(array('s'=>'Quantity','d'=>'Admin.Global'),$_smarty_tpl);?>
</label>
				<div class="col-lg-9">
					<input type="text" name="qty" id="qty" class="form-control fixed-width-sm" value="1" />
					<p class="help-block"><?php echo smartyTranslate(array('s'=>'In stock','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl);?>
 <span id="qty_in_stock"></span></p>
			...
			<div class="form-group">
				<div class="col-lg-9 col-lg-offset-3">
					...
					<?php echo smartyTranslate(array('s'=>'Add to cart','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl);?>
				...
				<table class="table" id="customer_cart">
					<thead>
						<tr>
							...
							<th><span class="title_box"><?php echo smartyTranslate(array('s'=>'Description','d'=>'Admin.Global'),$_smarty_tpl);?>
</span></th>
							<th><span class="title_box"><?php echo smartyTranslate(array('s'=>'Reference','d'=>'Admin.Global'),$_smarty_tpl);?>
</span></th>
							<th><span class="title_box"><?php echo smartyTranslate(array('s'=>'Price per unit','d'=>'Admin.Catalog.Feature'),$_smarty_tpl);?>
</span></th>
							<th><span class="title_box"><?php echo smartyTranslate(array('s'=>'Quantity','d'=>'Admin.Global'),$_smarty_tpl);?>
</span></th>
							<th><span class="title_box"><?php echo smartyTranslate(array('s'=>'Price','d'=>'Admin.Global'),$_smarty_tpl);?>
</span></th>
						</tr>
					</thead>
					<tbody>
		...
		<div class="form-group">
			<div class="col-lg-9 col-lg-offset-3">
				<div class="alert alert-warning"><?php echo smartyTranslate(array('s'=>'The prices are without taxes.','d'=>'Admin.Orderscustomers.Notification'),$_smarty_tpl);?>
</div>
			</div>
		</div>
		...
		<div class="form-group">
			<label class="control-label col-lg-3" for="id_currency">
				<?php echo smartyTranslate(array('s'=>'Currency','d'=>'Admin.Global'),$_smarty_tpl);?>
...
"><?php echo $_smarty_tpl->tpl_vars['currency']->value['name'];?>
		...
		<div class="form-group">
			<label class="control-label col-lg-3" for="id_lang">
				<?php echo smartyTranslate(array('s'=>'Language','d'=>'Admin.Global'),$_smarty_tpl);?>
...
"><?php echo $_smarty_tpl->tpl_vars['lang']->value['name'];?>
	...
	<div class="panel" id="vouchers_part" style="display:none;">
		<div class="panel-heading">
			...
			<?php echo smartyTranslate(array('s'=>'Vouchers','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl);?>

		</div>
		<div class="form-group">
			<label class="control-label col-lg-3">
				<?php echo smartyTranslate(array('s'=>'Search for a voucher','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl);?>
			...
			<div class="col-lg-9">
				<div class="row">
					...
					<div class="col-lg-6">
						<span class="form-control-static"><?php echo smartyTranslate(array('s'=>'Or','d'=>'Admin.Global'),$_smarty_tpl);?>
&nbsp;</span>
						<a class="fancybox btn btn-default" href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminCartRules'),'html','UTF-8');?>
&amp;addcart_rule&amp;liteDisplaying=1&amp;submitFormAjax=1#">
							<i class="icon-plus-sign-alt"></i>
							<?php echo smartyTranslate(array('s'=>'Add new voucher','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl);?>
			...
			<table class="table" id="voucher_list">
				<thead>
					<tr>
						...
						<th><span class="title_box"><?php echo smartyTranslate(array('s'=>'Value','d'=>'Admin.Global'),$_smarty_tpl);?>
</span></th>
						<th></th>
					</tr>
				</thead>
	...
	<div class="panel" id="address_part" style="display:none;">
		<div class="panel-heading">
			...
			<?php echo smartyTranslate(array('s'=>'Addresses','d'=>'Admin.Global'),$_smarty_tpl);?>
		...
		<div class="row">
			<div id="address_delivery" class="col-lg-6">
				<h4>
					...
					<?php echo smartyTranslate(array('s'=>'Delivery','d'=>'Admin.Global'),$_smarty_tpl);?>
				...
				<div class="well">
					<a href="" id="edit_delivery_address" class="btn btn-default pull-right fancybox"><i class="icon-pencil"></i> <?php echo smartyTranslate(array('s'=>'Edit','d'=>'Admin.Actions'),$_smarty_tpl);?>
</a>
			...
			<div id="address_invoice" class="col-lg-6">
				...
				<div class="well">
					<a href="" id="edit_invoice_address" class="btn btn-default pull-right fancybox"><i class="icon-pencil"></i> <?php echo smartyTranslate(array('s'=>'Edit','d'=>'Admin.Actions'),$_smarty_tpl);?>
</a>
		...
		<div class="row">
			<div class="col-lg-12">
				<a class="fancybox btn btn-default" id="new_address" href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['link']->value->getAdminLink('AdminAddresses'),'html','UTF-8');?>
&amp;addaddress&amp;id_customer=42&amp;liteDisplaying=1&amp;submitFormAjax=1#">
					<i class="icon-plus-sign-alt"></i>
					<?php echo smartyTranslate(array('s'=>'Add a new address','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl);?>
	...
	<div class="panel" id="carriers_part" style="display:none;">
		<div class="panel-heading">
			<i class="icon-truck"></i>
			<?php echo smartyTranslate(array('s'=>'Shipping','d'=>'Admin.Actions'),$_smarty_tpl);?>
		...
		<div id="carrier_form">
			<div class="form-group">
				<label class="control-label col-lg-3">
					<?php echo smartyTranslate(array('s'=>'Delivery option','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl);?>
			...
			<div class="form-group">
				<label class="control-label col-lg-3" for="shipping_price">
					<?php echo smartyTranslate(array('s'=>'Shipping price (Tax incl.)','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl);?>
			...
			<div class="form-group">
				<div class="checkbox col-lg-9 col-offset-3">
					<label for="carrier_recycled_package">
						...
						<?php echo smartyTranslate(array('s'=>'Recycled packaging','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl);?>
			...
			<div class="form-group">
				<div class="checkbox col-lg-9 col-offset-3">
					<label for="order_gift">
						...
						<?php echo smartyTranslate(array('s'=>'Gift','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl);?>

					</label>
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-lg-3" for="gift_message"><?php echo smartyTranslate(array('s'=>'Gift message','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl);?>
</label>
				<div class="col-lg-9">
	...
	<div class="panel" id="summary_part" style="display:none;">
		<div class="panel-heading">
			...
			<?php echo smartyTranslate(array('s'=>'Summary','d'=>'Admin.Global'),$_smarty_tpl);?>
			...
			<div class="row">
				<div class="col-lg-2">
					<div class="data-focus">
						<span><?php echo smartyTranslate(array('s'=>'Total products','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl);?>
</span><br/>
				...
				<div class="col-lg-2">
					<div class="data-focus">
						<span><?php echo smartyTranslate(array('s'=>'Total vouchers (Tax excl.)','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl);?>
</span><br/>
				...
				<div class="col-lg-2">
					<div class="data-focus">
						<span><?php echo smartyTranslate(array('s'=>'Total shipping (Tax excl.)','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl);?>
</span><br/>
				...
				<div class="col-lg-2">
					<div class="data-focus">
						<span><?php echo smartyTranslate(array('s'=>'Total taxes','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl);?>
</span><br/>
				...
				<div class="col-lg-2">
					<div class="data-focus">
						<span><?php echo smartyTranslate(array('s'=>'Total (Tax excl.)','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl);?>
</span><br/>
				...
				<div class="col-lg-2">
					<div class="data-focus data-focus-primary">
						<span><?php echo smartyTranslate(array('s'=>'Total (Tax incl.)','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl);?>
</span><br/>
		...
		<div class="row">
			<div class="order_message_right col-lg-12">
				<div class="form-group">
					<label class="control-label col-lg-3" for="order_message"><?php echo smartyTranslate(array('s'=>'Order message','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl);?>
</label>
					<div class="col-lg-6">
				...
				<div class="form-group">
					...
					<div class="col-lg-9 col-lg-offset-3">
						<a href="javascript:void(0);" id="send_email_to_customer" class="btn btn-default">
							<i class="icon-credit-card"></i>
							<?php echo smartyTranslate(array('s'=>'Send an email to the customer with the link to process the payment.','d'=>'Admin.Orderscustomers.Help'),$_smarty_tpl);?>

						</a>
						<a id="go_order_process" href="" class="btn btn-link _blank">
							<?php echo smartyTranslate(array('s'=>'Go on payment page to process the payment.','d'=>'Admin.Orderscustomers.Help'),$_smarty_tpl);?>
				...
				<div class="form-group">
					<label class="control-label col-lg-3"><?php echo smartyTranslate(array('s'=>'Payment','d'=>'Admin.Global'),$_smarty_tpl);?>
</label>
					<div class="col-lg-9">
...
" <?php if (isset($_POST['payment_module_name'])&&$_smarty_tpl->tpl_vars['module']->value->name==$_POST['payment_module_name']) {?>selected="selected"<?php }?>><?php echo $_smarty_tpl->tpl_vars['module']->value->displayName;?>
							...
							<?php } ?>
							<?php } else { ?>
								<option value="boorder"><?php echo smartyTranslate(array('s'=>'Back office order','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl);?>
</option>
							<?php }?>
						</select>
					</div>
				...
				<div class="form-group">
					<label class="control-label col-lg-3"><?php echo smartyTranslate(array('s'=>'Order status','d'=>'Admin.Shopparameters.Feature'),$_smarty_tpl);?>
</label>
					<div class="col-lg-9">
				...
				<div class="form-group">
					<div class="col-lg-9 col-lg-offset-3">
						<button type="submit" name="submitAddOrder" class="btn btn-default" />
							...
							<?php echo smartyTranslate(array('s'=>'Create the order','d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl);?>
