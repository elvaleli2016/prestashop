...
$catalogue = new MessageCatalogue('es-ES', array (
  ...
  array (
    ...
    'Delivery Date (Y-M-D)*' => 'Fecha de envío (Y-M-D) *',
    ...
    'Features tab on product page' => 'Pestaña de características en la página del producto',
    ...
    'Use CCC for CSS' => 'Utilizar CCC para las hojas de estilo CSS',
    ...
    'Select your default file encoding' => 'Selecciona el cifrado de archivos predeterminado',
  ...
  array (
    ...
    'Templates are recompiled when they are updated. If you experience compilation troubles when you update your template files, you should use Force Compile instead of this option. It should never be used in a production environment.' => 'Las plantillas serán recompiladas cada vez que sean modificadas. Si experimentas problemas de compilación al actualizar las plantillas, debes utilizar: "Forzar compilación" en vez de esta opción. Nunca utilizar en un entorno de producción.',
    'This forces Smarty to (re)compile templates on every invocation. This is handy for development and debugging. Note: This should never be used in a production environment.' => 'Esta opción obliga a Smarty a (re)compilar plantillas en cada invocación. Esto es útil para el desarrollo y la depuración. Nota: Esta opción nunca debe utilizarse en un entorno de producción.',
  ...
  array (
    ...
    'Error: invalid e-mail subject' => 'Error: asunto de email no válido',
    'Error: invalid e-mail address' => 'Error: dirección de email no válida',
    ...
    'The caching system is missing.' => 'Falta el sistema de almacenamiento en caché.',
    'To use Memcached, you must install the Memcache PECL extension on your server.' => 'Para utilizar Memcached, tienes que instalar la extensión PECL de Memcached en tu servidor.',
    ...
    'To use APC cache, you must install the APC PECL extension on your server.' => 'Para utilizar la caché APC, debes instalar la extensión APC PECL en tu servidor.',
    'To use Xcache, you must install the Xcache extension on your server.' => 'Para utilizar Xcache, debes instalar la extensión Xcache en tu servidor.',
    'To use Xcache, you must configure "xcache.var_size" for the Xcache extension (recommended value 16M to 64M).' => 'Para utilizar Xcache, debes configurar "xcache.var_size" para la extensión Xcache (valores recomendados de 16M a 64M).',
    ...
    'You are using PHP %s version. Soon, the latest PHP version supported by PrestaShop will be PHP 5.4. To make sure you’re ready for the future, we recommend you to upgrade to PHP 5.4 now!' => 'Estás utilizando la versión %s de PHP. Pronto la última versión de PHP soportada por PrestaShop será la 5.4. ¡Para garantizar que estás preparado para el futuro actualiza a PHP 5.4 ahora!',
    ...
    'URL rewriting failed to auto-generate a friendly URL for: %s' => 'La reescritura URL automática no pudo generar automáticamente una URL amigable para: %s',
    ...
    'Reference (%s) already exists (at line %d).' => 'La referencia (%s) ya existe (línea %d).',
    ...
    'Supply Order (%d) is not editable (at line %d).' => 'El pedido de suministro (%d) no se puede editar (línea %d).',
  ...
  array (
    ...
    'Edit quantity' => 'Modificar cantidad',
    'Physical' => 'Física',
    'Reserved' => 'Reservado',
    'Supplier' => 'Proveedor',
    'Root' => 'Raíz',
    ...
    '%s - Customer who placed an order with the guest checkout.' => '%s - Cliente que realizó un pedido con cuenta de invitado.',
...
Las categorías desactivadas se muestran en cursiva.',
  ...
  array (
    ...
    'This feature has been disabled. You can activate it here: %s.' => 'Esta característica ha sido desactivada. Puedes activarla aquí: %s.',
  ...
  array (
    ...
    'Will appear in the address bar of your web browser.' => 'Aparecerá en la barra de direcciones de tu navegador web.',
  ...
  array (
    ...
    'Validation failed for: %s' => 'Validación fallida para: %s',
    ...
    'Invalid mail name "%s"' => 'Nombre de correo electrónico "%s" no válido',
    'Directory "%s" cannot be created' => 'El directorio "%s" no puede ser creado',
    ...
    'Empty string found, please edit: "%s"' => 'Cadena vacía encontrada, por favor edita: "%s"',
    ...
    'No Subject was found for %s in the database.' => 'No se encontró ningún Asunto para %s en la base de datos.',
    'There was a problem getting the mail files.' => 'Se ha producido un error inesperado al obtener los archivos de e-mail.',
    'English language files must exist in %s folder' => 'Los archivos de idioma inglés deben existir en la carpeta %s',
    ...
    'Cannot write into the "%s"' => 'No se puede escribir el archivo: "%s"',
    'This expression uses a special syntax:' => 'Esta expresión utiliza una sintaxis especial:',
  ...
  array (
    ...
    'Directory "%s" cannot be created' => 'El directorio "%s" no puede ser creado',
    'File "%s" cannot be created' => 'El archivo "%s" no puede ser creado',
    ...
    'Please check rights for %s' => 'Por favor, comprueba los permisos para %s',
  ...
  array (
    ...
    'This feature cannot be disabled because it is currently in use.' => 'Esta característica no puede desactivarse porque está actualmente en uso.',
  ),
...
Gracias por su paciencia.',
  ...
  array (
    ...
    'If you have any questions, please visit our <a href="%doc%" target="_blank">documentation</a> and <a href="%forum%" target="_blank">community forum</a>.' => 'Si tiene alguna pregunta, por favor visite nuestra <a href="%doc%" target="_blank">documentación</a> y <a href="%forum%" target="_blank">nuestro foro de la comunidad</a>.',
  ...
  array (
    ...
    '%d keyword matches your query.' => '%d palabra clave coincidente con su búsqueda.',
